...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
            ...
            <select name="role_id" id="role_id" class="form-control" data-live-search="true"required>
        ...
        <div class="form-group">
            ...
            <input type="text" name="modelo" class="form-control" placeholder="Estado. 1.Activo 0.Inactivo">
